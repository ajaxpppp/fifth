package com.zgxt.backend.util.seal;

import com.zgxt.backend.util.seal.configuration.SealCircle;
import com.zgxt.backend.util.seal.configuration.SealConfiguration;
import com.zgxt.backend.util.seal.configuration.SealFont;
...
public class Seal {
     ...
     * @param name 姓名
     */
    public static byte[] getSealImg(String username,String name) {
        /**
         * 印章配置文件
         */
        ...
        //生成印章
        try {
//            SealUtil.buildAndStoreSeal(configuration, "src/main/resources/static/images/"+username+".png");
